...
\fontsize{12}{20}\selectfont{
  ...
  Throughout this article, I will provide insights into the fundamentals of BPMN (Business Process Model and Notation) and its role in visualizing and modeling business processes. I will then dive into my experience with Camunda after using it in a small project.
